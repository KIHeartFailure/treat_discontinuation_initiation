...
In the analyses of EF combined the EF used for MRA and loopdiuretics is r, mr, pEF and for rasi and bbl r, mrEF. 
...
However, all patients are presented for the respective treatments, 
not only those that were on the respective treatment at the time of HFH as in the following analyses. 

```{r, child = "../src/tabontreatall.Rmd"}

```

## Treatment discontinuation/initiation 

A logistic regression is performed separately for the 3 EF groups and EF combined for patients 
...
groups and EF combined and on those with the respective prior treatments. 
Only patients hospitalized for HF are included (so the controls are dropped from this analysis). 
