---
title: 'Statistical report: Discontinuation/Initiation of guideline-recommended HF treatments after a HF hospitalization - DRAFT'
...
The location (HF in-/out-patients) is according to the National Patient Registry 
...
Analyses were also preformed by eGFR and potassium. 
Adjustment in the models was not performed for the respective variable 
(i.e. potassium is not adjusted for when presented in subgroups by potassium and similar for eGFR). 

The subgroup analyses are only performed for the combined HFrEF/HFmrEF group. 
...
A logistic regression is performed separately for the 2 EF groups and EF combined for patients 
...
```{r, child = "../src/predtreatdisc_sub.Rmd"}
...
groups and EF combined. The analyses are performed on patients on the respective 
...
residuals for the outcome CV mortality/first HF hospitalization within 3 years. 
=> No action deemed necessary. 
