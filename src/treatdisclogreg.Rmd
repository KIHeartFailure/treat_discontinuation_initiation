...
mra <- funclogreg(efcat = c("HFpEF", "HFrEF"), medpre = "ddr_mra_prior", medpost = "ddr_mra_post", name = "MRA (HFpEF & HFrEF)")
mra8m <- funclogreg(efcat = c("HFpEF", "HFrEF"), medpre = "ddr_mra_prior8m", medpost = "ddr_mra_post", name = "MRA 2 dd/8 mo (HFpEF & HFrEF)")
