...
mra <- funclogreg(efcat = c("HFpEF", "HFmrEF", "HFrEF"), medpre = "ddr_mra_prior", medpost = "ddr_mra_post", name = "MRA (HFpEF, HFmrEF & HFrEF)")
mra8m <- funclogreg(efcat = c("HFpEF", "HFmrEF", "HFrEF"), medpre = "ddr_mra_prior8m", medpost = "ddr_mra_post", 
                    name = "MRA 2 dd/8 mo (HFpEF, HFmrEF & HFrEF)")

rasi <- funclogreg(efcat = c("HFmrEF", "HFrEF"), medpre = "ddr_rasi_prior", medpost = "ddr_rasi_post", name = "RASi (HFmrEF & HFrEF)")
rasi8m <- funclogreg(efcat = c("HFmrEF", "HFrEF"), medpre = "ddr_rasi_prior8m", medpost = "ddr_rasi_post", name = "RASi 2 dd/8 mo (HFmrEF & HFrEF)")

bbl <- funclogreg(efcat = c("HFmrEF", "HFrEF"), medpre = "ddr_bbl_prior", medpost = "ddr_bbl_post", name = "Bbl (HFmrEF & HFrEF)")
bbl8m <- funclogreg(efcat = c("HFmrEF", "HFrEF"), medpre = "ddr_bbl_prior8m", medpost = "ddr_bbl_post", name = "Bbl 2 dd/8 mo (HFmrEF & HFrEF)")

loop <- funclogreg(
  efcat = c("HFpEF", "HFmrEF", "HFrEF"), medpre = "ddr_loopdiuretic_prior", medpost = "ddr_loopdiuretic_post",
  valmedpre = "No", valmedpost = "Yes", name = "No Loop diuretics (HFpEF, HFmrEF & HFrEF)"
)
loop8m <- funclogreg(
  efcat = c("HFpEF", "HFmrEF", "HFrEF"), medpre = "ddr_loopdiuretic_prior8m", medpost = "ddr_loopdiuretic_post",
  valmedpre = "No", valmedpost = "Yes", name = "No Loop diuretics 2 dd/8 mo (HFpEF, HFmrEF & HFrEF)"
)
...
default_kable(efall,
  caption = "Treatment discontinuation (MRA, RASi, Bbl)/initiation (Loopdiuretics) - EF combined)",
  escape = TRUE,
  scale_down = FALSE
) %>%
  landscape()
