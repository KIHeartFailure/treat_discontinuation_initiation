...
funccoxreg2 <- function(time2, event2, discini) {
  ...
  # HFmrEF
  outmref <- funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_mra_prior",
    medpost = "ddr_mra_post", medname = "MRA", discini2 = discini
  )
  outmref <- rbind(outmref, funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_mra_prior8m",
    medpost = "ddr_mra_post", medname = "MRA 2 dd/8 mo", discini2 = discini
  ))

  outmref <- rbind(outmref, funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_rasi_prior",
    medpost = "ddr_rasi_post", medname = "RASi/ARNi", discini2 = discini
  ))
  outmref <- rbind(outmref, funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_rasi_prior8m",
    medpost = "ddr_rasi_post", medname = "RASi/ARNi 2 dd/8 mo", discini2 = discini
  ))

  outmref <- rbind(outmref, funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_bbl_prior",
    medpost = "ddr_bbl_post", medname = "Betablocker", discini2 = discini
  ))
  outmref <- rbind(outmref, funccoxreg(
    time = time2, event = event2, efcat = "HFmrEF", medpre = "ddr_bbl_prior8m",
    medpost = "ddr_bbl_post", medname = "Betablocker 2 dd/8 mo", discini2 = discini
  ))
...
default_kable(discdatahosphf$outprint,
  caption = "Treatment discontinuation - First HF hospitalization within 3 years",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, "HFrEF" = 2, " HFmrEF" = 2, "HFrEF + HFmrEF" = 2))
...
default_kable(discdatadeathcvhosphf$outprint,
  caption = "Treatment discontinuation - CV mortality/first HF hospitalization within 3 years",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, "HFrEF" = 2, " HFmrEF" = 2, "HFrEF + HFmrEF" = 2))
...
forestfunc(data = inidatadeath$outforest, discini = "initiation", axismy = c(0.4, 0.6, 1, 1.6, 2.2))
```
...
forestfunc(data = inidatadeathcv$outforest, discini = "initiation", axismy = c(0.4, 0.6, 1, 2, 3))
```

```{r treatinicoxreghosphf, cache=cacheon, dependson="treatdisccoxreg"}
...
default_kable(inidatahosphf$outprint,
  caption = "Treatment initiation - First HF hospitalization within 3 years",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, "HFrEF" = 2, " HFmrEF" = 2, "HFrEF + HFmrEF" = 2))
...
```{r treatinicoxregdeathcvhosphfp, cache=cacheon, dependson="treatdisccoxreg"}
...
default_kable(inidatadeathcvhosphf$outprint,
  caption = "Treatment initiation - CV mortality/first HF hospitalization within 3 years",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, "HFrEF" = 2, " HFmrEF" = 2, "HFrEF + HFmrEF" = 2))
