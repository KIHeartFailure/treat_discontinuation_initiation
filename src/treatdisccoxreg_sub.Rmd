...
forestfunc <- function(data, discini, axismy) {
  foresttmp <- tibble(
    hf = c(
      paste0("MRA ", discini),
  ...
  axis(2,
    at = max(forest$order) + 1,
    labels = "HR (95% CI)",
    cex.axis = cextext, tick = FALSE, las = 2, line = -16, hadj = 0.5, font = 2
  )
  axis(2,
    at = forest %>% pull(order),
    labels = forest %>% pull(hrci),
    cex.axis = cextext, tick = FALSE, las = 2, line = -16, hadj = 0.5
  )

  axis(2,
    at = max(forest$order) + 1,
    labels = "P-value",
    cex.axis = cextext, tick = FALSE, las = 2, line = -20.5, hadj = 0.5, font = 2
  )
  axis(2,
    at = forest %>% pull(order),
    labels = forest %>% pull(pval),
    cex.axis = cextext, tick = FALSE, las = 2, line = -20.5, hadj = 0.5
  )
...
default_kable(discdatadeath$outprint,
  caption = paste0("Treatment discontinuation - All-cause mortality within 3 years by eGFR"),
  escape = TRUE
) %>%
  landscape() %>%
...
```{r treatdisccoxregdeathforestsub, fig.cap = "Treatment discontinuation - All-cause mortality", cache=cacheon, dependson=c("treatdisccoxregsub", "treatdisccoxregforestsub", "treatdisccoxregdeathsub"), fig.width=10, fig.height=7}

forestfunc(data = discdatadeath$outforest, discini = "discontinuation", axismy = c(0.5, 1, 1.5, 2))
```
...
default_kable(discdatadeathcv$outprint,
  caption = "Treatment discontinuation - CV mortality within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
```{r treatdisccoxregdeathcvforestsub, , fig.cap = "Treatment discontinuation - CV mortality", cache=cacheon, dependson=c("treatdisccoxregsub", "treatdisccoxregforestsub", "treatdisccoxregdeathcvsub"), fig.width=10, fig.height=7}

forestfunc(data = discdatadeathcv$outforest, discini = "discontinuation", axismy = c(0.4, 0.6, 1, 1.6, 2.2))
```
...
default_kable(discdatahosphf$outprint,
  caption = "Treatment discontinuation - First HF hospitalization within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
default_kable(discdatadeathcvhosphf$outprint,
  caption = "Treatment discontinuation - CV mortality/first HF hospitalization within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
default_kable(inidatadeath$outprint,
  caption = paste0("Treatment initiation - All-cause mortality within 3 years by eGFR"),
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
```{r treatinicoxregdeathforestsub, fig.cap = "Treatment initiation - All-cause mortality", cache=cacheon, dependson=c("treatdisccoxregsub", "treatdisccoxregforestsub", "treatinicoxregdeathsub"), fig.width=10, fig.height=7}

forestfunc(data = inidatadeath$outforest, discini = "initiation", axismy = c(0.4, 0.6, 1, 1.6, 2.8))
```
...
default_kable(inidatadeathcv$outprint,
  caption = "Treatment initiation - CV mortality within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
```{r treatinicoxregdeathcvforestsub, fig.cap = "Treatment initiation - CV mortality", cache=cacheon, dependson=c("treatdisccoxregsub", "treatdisccoxregforestsub", "treatinicoxregdeathcvsub"), fig.width=10, fig.height=7}

forestfunc(data = inidatadeathcv$outforest, discini = "initiation", axismy = c(0.4, 0.6, 1, 2, 4, 6))
```
...
default_kable(inidatahosphf$outprint,
  caption = "Treatment initiation - First HF hospitalization within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
...
default_kable(inidatadeathcvhosphf$outprint,
  caption = "Treatment initiation - CV mortality/first HF hospitalization within 3 years by eGFR",
  escape = TRUE
) %>%
  landscape() %>%
  add_header_above(c(" " = 1, " " = 1, ">=60" = 2, "<60" = 2))
